    ...
    root: ({ props, context, parent }) => ({
        class: [
            ...
            // Success Button
            {
                ...
                'bg-emerald-500 dark:bg-emerald-400': props.severity === 'success' && !props.text && !props.outlined && !props.plain,
                'border border-emerald-500 dark:border-emerald-400': props.severity === 'success' && !props.text && !props.outlined && !props.plain
            },
            // Success Text Button
            { 'text-emerald-500 dark:text-emerald-400': props.text && props.severity === 'success' && !props.plain },
            // Success Outlined Button
            { 'text-emerald-500 border border-emerald-500 hover:bg-emerald-300/20': props.outlined && props.severity === 'success' && !props.plain },

            // Info Button
            {
                'text-white dark:text-surface-900': props.severity === 'info' && !props.text && !props.outlined && !props.plain,
                'bg-primary-500 dark:bg-blue-400': props.severity === 'info' && !props.text && !props.outlined && !props.plain,
            ...
            // Success
            { 'hover:bg-emerald-600 dark:hover:bg-emerald-300 hover:border-emerald-600 dark:hover:border-emerald-300': props.severity === 'success' && !props.text && !props.outlined && !props.plain },
            { 'focus:ring-emerald-400/50 dark:focus:ring-emerald-300/50': props.severity === 'success' },
            // Text & Outlined Button
            { 'hover:bg-emerald-300/20': (props.text || props.outlined) && props.severity === 'success' && !props.plain },
