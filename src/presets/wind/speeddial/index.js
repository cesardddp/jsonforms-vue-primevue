export default {
    ...
    button: {
        root: ({ props, context }) => ({
            class: [
                ...
                // Plain Button
                { 'text-black bg-gray-500 border border-gray-500': props.plain && !props.outlined && !props.text },
                // Plain Text Button
                ...
                // Secondary Button
                {
                    'text-black dark:text-surface-900': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain,
                ...
                // Success Button
                {
                    'text-black dark:text-green-900': props.severity === 'success' && !props.text && !props.outlined && !props.plain,
                ...
                // Info Button
                {
                    'text-black dark:text-surface-900': props.severity === 'info' && !props.text && !props.outlined && !props.plain,
                ...
                // Warning Button
                {
                    'text-black dark:text-surface-900': props.severity === 'warning' && !props.text && !props.outlined && !props.plain,
                ...
                // Help Button
                {
                    'text-black dark:text-surface-900': props.severity === 'help' && !props.text && !props.outlined && !props.plain,
                ...
                // Danger Button
                {
                    'text-black dark:text-surface-900': props.severity === 'danger' && !props.text && !props.outlined && !props.plain,
    ...
    action: {
        class: [
            ...
            // Appearance
            'bg-surface-600 dark:bg-surface-0/80 text-black dark:text-surface-900/80',
