    ...
    button: {
        root: ({ parent }) => ({
            class: [
                ...
                // Alignments
                'items-center inline-flex text-left align-bottom justify-center',
                ...
                // Info Button
                {
                    ...
                    'bg-primary-500 dark:bg-blue-400': parent.props.severity === 'info' && !parent.props.text && !parent.props.outlined && !parent.props.plain,
